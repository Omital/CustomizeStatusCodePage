...
using CustomizeStatusCodePage.Sessions;
using CustomizeStatusCodePage.Web.Controllers.Results;
using CustomizeStatusCodePage.Web.Models;
using CustomizeStatusCodePage.Web.Models.Account;
...
{
    public class AccountController : CustomizeStatusCodePageControllerBase
    {
